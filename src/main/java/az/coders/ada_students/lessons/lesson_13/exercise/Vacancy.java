...
public class Vacancy {
    public static void main(String[] args) {
        String[] vacancyOne = {"Chief Programming Specialist",
                "Education Higher education (Preference will be given to those with knowledge in Computer " +
                        ...
                        "Programming language Experience in Python, C #, C ++ programming languages " +
                        ...
                        "Ability to work on Linux and Windows operating systems.", "2000-2500 AZN", "hr@millikart.az",};

        String[] vacancyTwo = {"SEO Specialist",
                "Defining the SEO strategy of the portal, developing the semantic core," +
                        ...
                        "on Google using SEO tools, preparation of SEO texts.", "400-500 AZN", "info@tender.az"};

        String[] vacancyThree = {"General English And IELTS Instructor",
                "With education degrees and IELTS " +
                        ...
                        "written communication skills; Ability to work collaboratively as a member of a team.", "800-1000 AZN",
                "office@maxgroup.info.az"};

        String[] vacancyFour = {"Lawyer",
                "To be a member of the Bar Association of the Republic of Azerbaijan; At " +
                        ...
                        "skills in standard MS Office programs (Word, Excel, etc.)", "2000-2500 AZN", "office@mgc.az"};

        String[] vacancyFive = {"Back-End Developer",
                "Requirements: Proficient with Java, REST APIs, Microservice " +
                        ...
                        "problem-solving skills with keen attention to detail; Ability to work closely with other team members",
                "1000-1500 AZN", "tofigk@crbn.az"};

        String[] vacancySix = {"Marketing Manager",
                "Must be a graduate of the Faculty of Economics; Preference is given to those studying in Turkey " +
                        ...
                        "team and manage a team; Customer satisfaction should be preferred", "1500-3000 AZN",
                "hr@deluxekamin.com"};

        String[] vacancySeven = {"SMM Manager", "At the professional level, Fb Ads Manager, Fb Business Manager, " +
                ...
                "advantage", "500-800 AZN", "azcars@azcars.az"};

        String[] vacancyEight = {"Accountant",
                "Development of operations in 1C program; Banking and cash operations; Ability to use e-taxes.gov.az, " +
                        ...
                        "Computer: Must know Microsoft Office Programs (Word, Excell), Outlook Express!", "500-700 AZN",
                "info@mjfinance.az"};

        String[] vacancyNine = {"Head of the Department of Seed and Plant Production",
                ...
                "900 AZN", "aysel.ramazanova@ekol.az"};

        String[] vacancyTen = {"Bakers, confectioners and confectioners, masters of yeast",
                "OVEN Bakery and Confectionery Production Plant requires experienced bakers, " +
                        ...
                        "in accordance with the Labor Code of the Republic of Azerbaijan;", "600-700 AZN"};
